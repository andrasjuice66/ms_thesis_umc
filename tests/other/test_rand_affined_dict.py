...
from monai.transforms import LoadImage, EnsureChannelFirst, RandAffined
...
def main():
    ...
    for _ in range(N_AUGS):
        aug_dict = rand_affined(img_dict)
        aug = aug_dict["image"]
        aug_list.append(aug)

    plot_affine_augs(img, aug_list, out_path="brain_age_pred/tests/rand_affined_augs.png")
